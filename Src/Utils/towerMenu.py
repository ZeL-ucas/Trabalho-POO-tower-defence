...
class TowerMenu:
    ...
    def draw(self):
        tower_pos = self.tower.get_position()
    ...
    def is_clicked(self, mouse_pos):
        button_x = self.tower.get_position()[0] + self.radius * math.cos(math.radians(45)) - self.upgrade_rect.width // 2
        button_y = self.tower.get_position()[1] - self.radius * math.sin(math.radians(45)) - self.upgrade_rect.height // 2
